function cost = EvaluateCostISRFoot(be,rec,act,acmin,pu_steel_footings)

%------------------------------------------------------------------------
% Syntax:
% cost = EvaluateCostISRFoot(be,rec,act,acmin,pu)
%
%------------------------------------------------------------------------
...
%                               the transversal cross-section (upper boundary)
%
...
cost=act*(be-2*rec)*7800*0.000001*pu_steel_footings+...
                        acmin*(be-2*rec)*7800*1e-6*pu_steel_footings;
