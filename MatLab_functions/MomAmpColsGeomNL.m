...
%                   that causes the second-order moments (cm)
%
%         Mamp:     amplified moment in the direction of question (Ton-m)
%
...
while(abs((QX1-QX01)/QX01)>eps)
    ...
    [Ke1,fe1]=beam2ge(ex1,ey1,ep1,QX1,eq1);
