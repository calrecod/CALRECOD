function [sepbarsRestricSections,b,h,inertia_modif,dispositionBar_Der,barArrangementDerComp,...
    ...
    fc,fy,load_conditions,cols_sym_asym_isr,duct,b_rec,rebarDesignPlots,graphConvergencePlot)
...
%                               compression)
%
% INPUT:  fc:                   is the concrete $f'_c$ in units (Kg/cm^2)
%
...
while bh_condition==0
    ...
    bestCost=pu_beams*best_Area03*7800e-6;
    ...
    if cols_sym_asym_isr~="ISR"
        ...
        [sepbarsRestric,cbest,b,h,bestBarDisposition,bestCost,arregloVar_t1,arregloVar_t2,...
            ef,bestMr,area_var_t]=ISR1tRebarBeamsOptimization(E,b,h,fy,...
            fc,b_rec,h_rec,conditions_right,t2Best,pu_beams);
    ...
    % Compute cost with the ISR
    bestCost=pu_beams*best_Area02*7800e-6;
    ...
    if cols_sym_asym_isr~="ISR"
        ...
        [sepbarsRestric,cbest,b,h,bestBarDisposition,bestCost,arregloVar_t1,arregloVar_t2,...
            ef,bestMr,area_var_t]=ISR1tRebarBeamsOptimization(E,b,h,fy,...
            fc,b_rec,h_rec,conditions_central,t2Best,pu_beams);
    ...
    % Compute cost with the ISR
    bestCost=pu_beams*best_Area01*7800e-6;
    ...
    if cols_sym_asym_isr~="ISR"
        ...
        [sepbarsRestric,cbest,b,h,bestBarDisposition,bestCost,arregloVar_t1,arregloVar_t2,...
            ef,bestMr,area_var_t]=ISR1tRebarBeamsOptimization(E,b,h,fy,...
            fc,b_rec,h_rec,conditions_izq,t2Best,pu_beams);
    ...
    bestCostVar=(unitCostIzq+unitCostCentral+unitCostDer)/3*span;
