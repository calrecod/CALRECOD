function [raiz]=bisectionMrRebarBeams(c1,c2,fr,E,h,b,h_rec,fdpc,beta,...
            ea,arreglo_t1,arreglo_t2,disposicion_varillado,rebarAvailable)
...
%
%         h_rec:        is the concrete cover parameter vertically, (cm)
%
...
%                       7 according to the available commercial rebar types
%                       stated by default
%
%         disposicion_varillado: local coordinates of rebars laid out over 
...
%------------------------------------------------------------------------
    ...
    [eleMec]=eleMecanicosRebarBeams(c1,aUno,fdpc,h,b,h_rec,E,arreglo_t1,...
                            arreglo_t2,disposicion_varillado,rebarAvailable);
