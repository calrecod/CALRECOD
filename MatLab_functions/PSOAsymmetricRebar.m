...
while nopciones==0
    ...
    for iteration=1:iterationsNumber
        ...
        for i=1:numberOfParticles
            ...
            nbsup=number_rebars_sup(op1);
            nbinf=number_rebars_inf(op2);
            nbizq=number_rebars_izq(op3);
            nbder=number_rebars_der(op4);
            
            [disposition_rebar,separacion_hor1,separacion_hor2,...
            separacion_ver1,separacion_ver2]=dispositionRebarAsymmetric(b,...
            h,sepMin,rec,nv,nbsup,nbinf,...
            nbizq,nbder,varDisponibles,op1,op2,op3,op4);
            
            [performance(i),diagramaInteraccion,eficiencia_table,cp,cxy]=...
                EvaluateAsymmetric(load_conditions,npuntos,position,b,h,...
                fy,fdpc,beta1,E,nbsup,nbinf,nbizq,nbder,varDisponibles,...
                disposition_rebar);
