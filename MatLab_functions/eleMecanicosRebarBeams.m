...
sumaF=0;
for i=1:nv
    eMecRebar(i,1)=rebarAvailable(arreglo_total(i),4);
    ...
    eMecRebar(i,7)=eMecRebar(i,6)*eMecRebar(i,1)*0.001;
    eMecRebar(i,8)=eMecRebar(i,7)*(eMecRebar(i,4)-0.5*h)*0.01;
