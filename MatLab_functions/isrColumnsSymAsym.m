function [Inertia_xy_modif,b,h,bestArrangement,bestDisposition,cost_elem_col,...
    Ac_sec_elem,Ef_sec_col,Mr_col]=isrColumnsSymAsym(pu_cols,height,b,h,rec,fy,...
    fc,load_conditions,cols_sym_asym_isr,condition_cracking,ductility,wac,...
    RebarAvailable,optimaPlot,plotsISRdiagrams,plotRebarDesign)
...
if cols_sym_asym_isr=="Symmetric"
    ...
    [Mr_col,h,Inertia_xy_modif,Ac_sec_elem,cost_elem_col,bestdiagram,bestnv,...
...
elseif cols_sym_asym_isr=="Asymmetric"
    ...
    bestArrangement,bestDisposition,Mr_col,bestcxy,bestCP,cost_elem_col]=...
